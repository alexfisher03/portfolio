...
const Projects = () => {
  return (
    <div
      name="projects"
      className="w-full md:h-screen text-gray-400 bg-[#091824]"
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 text-gray-400 border-blue-200">
            Projects
          </p>
        ...
        <div className="sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div
            style={{ backgroundImage: `url(${BBIMG})` }}
            ...
            <div className="opacity-0 group-hover:opacity-100 duration-500">
              ...
              <div className="pt-8 text-center">
                <a href="https://www.socialbarbell.com" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-gray-400 text-[#091824] font-bold text-lg hover:scale-110 duration-300">
                    Visit App
                  </button>
                </a>
                <a
                  href="https://www.github.com/alexfisher03/barbell"
                  target="_blank"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-gray-400 text-[#091824] font-bold text-lg hover:scale-110 duration-300">
                    View Code
